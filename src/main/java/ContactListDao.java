//public class ContactsBonus {
//}
import java.util.ArrayList;
import java.util.List;
// TODONE: create a Contact class entity that maps contacts correctly
// TODONE: create a Contacts interface with the required methods
// TODONE: add a method to the DaoFactory to get an implementation of the contacts DAO
// TODONE: create the needed controller and view code to give the user an interface that will CRUD contacts
